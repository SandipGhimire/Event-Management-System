    ...
    <header className="h-16 bg-secondary/80 backdrop-blur-md border-b border-gray-800 flex items-center justify-between px-4 lg:px-8 sticky top-0 z-50">
      <div className="flex items-center gap-4 text-gray-400">
        <button 
          ...
          className="lg:hidden p-2 hover:bg-white/10 rounded-lg text-primary"
        >
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16m-7 6h7" />
          </svg>
        </button>
        <span className="hidden sm:inline text-sm font-medium">Pages / {window.location.pathname.substring(1) || 'Home'}</span>
      </div>
